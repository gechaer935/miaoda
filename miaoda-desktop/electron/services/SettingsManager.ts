...
export interface AppSettings {
    ...
    // runtime without a redeploy. Also overridable by env MIAODA_CODE_VERIFY=off.
    ...
    miaodaApiBaseUrl?: string;
    miaodaDeviceId?: string;
    miaodaAuthToken?: string;
    miaodaAuthTokenEncrypted?: string;
    miaodaAuthExpiresAt?: string;
    miaodaUsername?: string;
    miaodaAuthMode?: 'account';
    miaodaAsrModel?: 'paraformer-realtime-v2' | 'fun-asr-realtime' | 'qwen3-asr-flash-realtime';
    miaodaAsrPreRollEnabled?: boolean;
    miaodaLastQuota?: {
