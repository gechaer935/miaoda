...
// behavior that has been removed from 秒答's runtime in the
...
process.env.MIAODA_TEST_USER_DATA = '/Users/alice/Library/Application Support/秒答';

const VALID_IMAGE = '/Users/alice/Library/Application Support/秒答/screenshots/test.png';
