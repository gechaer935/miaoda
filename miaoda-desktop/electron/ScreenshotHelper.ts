  ...
  switch (status) {
    ...
    case 'denied':
      throw new Error(
        ...
        'Privacy & Security > Screen Recording, then restart 秒答.'
      );
    case 'restricted':
      throw new Error(
    ...
    case 'not-determined':
      ...
      throw new Error(
        ...
        'Please restart 秒答 — you will be prompted to grant access on next launch.'
      );
  }
}
      ...
      if ((error as NodeJS.ErrnoException).name === 'NotAllowedError') {
        ...
        throw new Error(
          process.platform === 'darwin'
            ...
            : 'Screen capture permission denied by the OS. Please try again or restart 秒答.'
        );
      }
