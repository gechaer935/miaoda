...
export class DatabaseManager {
    ...
    private constructor() {
        ...
        this.dbPath = path.join(userDataPath, 'miaoda.db');
...
秒答 is a real-time AI meeting assistant designed to help you stay focused, informed, and fast-moving during calls. Get live insights while you speak, instant answers to questions, and structured notes after every meeting.
...
- **Usage**: Track your interaction history and see how 秒答 assisted you.
...
### Undetectability
Unlock the **Undetectability** add-on to keep 秒答 invisible during screen sharing.
...
**Once downloaded, return to Settings → Credentials in 秒答 and select this file to complete setup.**
...
support@example.invalid`;
        ...
        const demoMeeting: Meeting = {
            ...
            duration: "5:00",
            summary: "秒答 使用完整指南 - 你的实时 AI 会议助手。",
            detailedSummary: {
            ...
            transcript: [
                { speaker: 'interviewer', text: "Welcome to 秒答! Let me show you how it works.", timestamp: 0 },
                ...
                { speaker: 'user', text: "How do I hide 秒答 during screen share?", timestamp: 60000 },
            ...
            usage: [
                { type: 'assist', timestamp: 15000, question: 'What features does 秒答 have?', answer: '秒答 offers 5 quick action buttons, screenshot analysis, real-time transcription, and comprehensive meeting notes.' },
