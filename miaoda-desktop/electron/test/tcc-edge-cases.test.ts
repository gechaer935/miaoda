...
async function resolveMacScreenCaptureCapabilityTEST(
  ...
  if (status === 'restricted') {
    return {
      ...
      sourceCount: 0,
      message: 'Screen Recording is restricted by device policy. Interviewer audio will not be captured. Contact your administrator to allow screen capture for 秒答.',
    };
  }
