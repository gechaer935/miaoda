...
//
// Design choices:
//   - Args come via an env var (MIAODA_TC), NOT interpolated into source, so a
...
export const RESULT_SENTINEL_START = '__MIAODA_RESULT_START__';
export const RESULT_SENTINEL_END = '__MIAODA_RESULT_END__';
export const TC_ENV = 'MIAODA_TC';
 ...
 * is supplied to the process via the MIAODA_TC env var (JSON-encoded). One
