...
//   1. typo/greeting-tolerant intro routing (no "I'm 秒答")
...
describe('Phase 3: exact-source-code hallucination guard', () => {
  for (const q of [
    ...
    'show me actual code from 秒答', 'give me a repo-verifiable snippet',
...
describe('1000-q benchmark 2026-06-06b: real routing gaps closed', () => {
  test('SMS-spelling identity "who u r" → identity (no 秒答 leak)', () => {
