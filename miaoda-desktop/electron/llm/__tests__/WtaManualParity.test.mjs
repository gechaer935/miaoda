...
describe('Issue 3: WTA ↔ manual routing parity (single source of truth)', () => {
  const questions = [
    ...
    'Tell me about 秒答.', 'Where did you study?', 'What is your biggest strength?',
  ];
  ...
  test('WTA profile/identity answers always use first_person_candidate voice', () => {
    for (const q of ['What is your name?', 'Why should we hire you?', 'Rate your Python skills out of 10.', 'Tell me about 秒答.']) {
