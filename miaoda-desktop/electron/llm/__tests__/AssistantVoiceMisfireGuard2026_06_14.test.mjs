...
// "I'm 秒答, an AI assistant. I was made by the 秒答 team." or the stock
...
describe('detectAssistantVoiceMisfire — identity misfire', () => {
  test('flags the canned identity reply', () => {
    const r = detectAssistantVoiceMisfire("I'm 秒答, an AI assistant. I was made by the 秒答 team.");
  ...
  test('flags the canned creator reply', () => {
    assert.equal(detectAssistantVoiceMisfire('I was made by the 秒答 team.').reason, 'identity');
  });
...
describe('detectAssistantVoiceMisfire — does NOT over-trigger', () => {
  ...
  test('"I\'m an AI assistant." IS a misfire', () => {
    assert.equal(detectAssistantVoiceMisfire("I'm an AI assistant.").isMisfire, true);
  });
