...
export const RECOGNITION_LANGUAGES: Record<string, LanguageOption> = {
    ...
    'cantonese': { label: 'Cantonese', code: 'cantonese', bcp47: 'zh-HK', iso639: 'zh', group: 'Chinese' },
    'wu-chinese': { label: 'Wu Chinese', code: 'wu-chinese', bcp47: 'zh-CN', iso639: 'zh', group: 'Chinese' },
    'minnan': { label: 'Minnan Chinese', code: 'minnan', bcp47: 'zh-TW', iso639: 'zh', group: 'Chinese' },
    'hakka': { label: 'Hakka Chinese', code: 'hakka', bcp47: 'zh-CN', iso639: 'zh', group: 'Chinese' },
    'gan-chinese': { label: 'Gan Chinese', code: 'gan-chinese', bcp47: 'zh-CN', iso639: 'zh', group: 'Chinese' },
    'xiang-chinese': { label: 'Xiang Chinese', code: 'xiang-chinese', bcp47: 'zh-CN', iso639: 'zh', group: 'Chinese' },
    'jin-chinese': { label: 'Jin Chinese', code: 'jin-chinese', bcp47: 'zh-CN', iso639: 'zh', group: 'Chinese' },
    ...
    'filipino': { label: 'Filipino', code: 'filipino', bcp47: 'fil-PH', iso639: 'fil', group: 'Filipino' },
