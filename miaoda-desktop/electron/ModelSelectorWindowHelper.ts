...
export class ModelSelectorWindowHelper {
    ...
    private createWindow(
        ...
        const windowSettings: Electron.BrowserWindowConstructorOptions = {
            ...
            // capture handler (LiteOverlay.tsx) dispatching the
        ...
        this.window.once('ready-to-show', () => {
            ...
            // the model selector on the 秒答 overlay doesn't activate
            // 秒答 and dim the user's foreground app (Zoom/browser) mid
        ...
        //   • renderer mousedown capture handler in LiteOverlay.tsx
    ...
    private applyNativeCaptureProtection(enable: boolean): void {
        ...
        try {
            ...
            if (typeof method === 'function') {
                method(this.window.getNativeWindowHandle());
            }
        } catch (e) {
            console.warn(`[ModelSelectorWindowHelper] Failed to ${enable ? 'apply' : 'remove'} native capture protection:`, e);
        }
    }
