...
const FLAG_ENV = {
  intelligenceOsEnabled: 'MIAODA_INTELLIGENCE_OS',
  profileTreeV2: 'MIAODA_PROFILE_TREE_V2',
  contextRouterV2: 'MIAODA_CONTEXT_ROUTER_V2',
  liveTranscriptBrain: 'MIAODA_LIVE_TRANSCRIPT_BRAIN',
  promptAssemblerV2: 'MIAODA_PROMPT_ASSEMBLER_V2',
  answerDiversityGuard: 'MIAODA_ANSWER_DIVERSITY_GUARD',
  meetingMemoryV2: 'MIAODA_MEETING_MEMORY_V2',
  globalSearchV2: 'MIAODA_GLOBAL_SEARCH_V2',
  inMeetingSearchV2: 'MIAODA_IN_MEETING_SEARCH_V2',
  lectureIntelligenceV2: 'MIAODA_LECTURE_INTELLIGENCE_V2',
  diagramIntelligence: 'MIAODA_DIAGRAM_INTELLIGENCE',
  hindsightMemory: 'MIAODA_HINDSIGHT_MEMORY',
  hindsightLiveRecall: 'MIAODA_HINDSIGHT_LIVE_RECALL',
  hindsightPostMeetingRetain: 'MIAODA_HINDSIGHT_POST_MEETING_RETAIN',
  trace: 'MIAODA_INTELLIGENCE_TRACE',
  durableMemoryWindow: 'MIAODA_DURABLE_MEMORY_WINDOW',
};
...
describe('Rollout — enabled mode (per-flag, independent)', () => {
  ...
  test('the recommended rollout order is all independently gated (no hard coupling)', () => {
    ...
    process.env.MIAODA_PROFILE_TREE_V2 = 'on';
    __resetIntelligenceFlagsCache();
...
describe('Rollout — instant rollback', () => {
  ...
  test('an explicit OFF overrides everything (instant kill)', () => {
    process.env.MIAODA_DIAGRAM_INTELLIGENCE = 'off';
    __resetIntelligenceFlagsCache();
