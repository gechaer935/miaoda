...
// getInterviewIntro().
//
// THIS IS A FACADE, NOT A REWRITE. 秒答 already answers every one of these
...
//   • NEVER "I am 秒答" (assistant-meta asks bail; these methods ask candidate
...
export interface CandidatePerspectiveVerdict {
  ...
  /** True when an "I am 秒答 / an AI assistant" answer is a LEAK here. */
...
export class ProfileTreeService {
   ...
   * therefore whether an "I am 秒答 / an AI assistant" answer would be a LEAK.
   *
   * This is the deterministic gate that prevents the headline bug ("introduce
   * yourself → I'm 秒答"). It does NOT generate text; a caller uses the verdict
   ...
   * questions ("are you an AI?", "what is 秒答?") are exempt — there the
