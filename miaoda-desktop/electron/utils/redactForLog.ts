...
const VALUE_PATTERNS: Array<{ regex: RegExp; replacement: string }> = [
    ...
    { regex: /x-(miaoda|trial|api)-(key|token)\s*[:=]\s*[A-Za-z0-9._~+\/=:-]{8,}/gi, replacement: '$&[REDACTED]'.replace(/(=|:)\s*[A-Za-z0-9._~+\/=:-]{8,}/, '$1 [REDACTED]') },
    { regex: /miaoda_sk_[A-Za-z0-9._-]+/gi, replacement: REDACTED },
