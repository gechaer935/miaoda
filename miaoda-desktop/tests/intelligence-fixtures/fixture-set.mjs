...
// Helper to create structured fixture sets for 秒答 intelligence evaluation

/**
 * Create a fixture set for a given role profile.
 * Used by eval harness to test 秒答's intelligence pipeline.
 */
...
export const backendEngineer = {
  ...
  resume: {
    identity: { name: 'Aarav Menon', email: 'aarav.menon@example.com', phone: '415-555-0142', location: 'San Francisco, CA' },
...
export const mlEngineer = {
  ...
  resume: {
    identity: { name: 'Priya Sharma', email: 'priya.sharma@example.com', phone: '650-555-0198', location: 'Mountain View, CA' },
...
export const productManager = {
  ...
  resume: {
    identity: { name: 'Jordan Kim', email: 'jordan.kim@example.com', phone: '206-555-0173', location: 'Seattle, WA' },
...
export const salesRep = {
  ...
  resume: {
    identity: { name: 'Marcus Williams', email: 'marcus.w@example.com', phone: '312-555-0156', location: 'Chicago, IL' },
...
export const uxDesigner = {
  ...
  resume: {
    identity: { name: 'Sofia Rodriguez', email: 'sofia.r@example.com', phone: '718-555-0139', location: 'Brooklyn, NY' },
...
export const dataAnalyst = {
  ...
  resume: {
    identity: { name: 'Chen Wei', email: 'chen.wei@example.com', phone: '206-555-0184', location: 'Seattle, WA' },
...
export const devopsEngineer = {
  ...
  resume: {
    identity: { name: 'Kwame Osei', email: 'kwame.osei@example.com', phone: '310-555-0167', location: 'Los Angeles, CA' },
...
export const csm = {
  ...
  resume: {
    identity: { name: 'Aisha Patel', email: 'aisha.patel@example.com', phone: '617-555-0128', location: 'Boston, MA' },
...
export const securityAnalyst = {
  ...
  resume: {
    identity: { name: 'David Okonkwo', email: 'd.okonkwo@example.com', phone: '512-555-0147', location: 'Austin, TX' },
...
export const founderCEO = {
  ...
  resume: {
    identity: { name: 'Michael Zhang', email: 'mzhang@example.com', phone: '617-555-0193', location: 'Boston, MA' },
