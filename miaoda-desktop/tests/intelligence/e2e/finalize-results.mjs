...
const meta = {
  ...
  leaks: { identity: cnt('miaoda_identity'), falseRefusal: cnt('false_refusal'), stealth: cnt('stealth_evasion'), codingProfile: cnt('coding_profile'), forbiddenSubstring: cnt('forbidden_substring'), contextLeak: cnt('context_leak'), invented: cnt('invented_link'), hallucinated: cnt('hallucinated_source'), safetyNotRouted: cnt('safety_not_routed') },
  latency: {
