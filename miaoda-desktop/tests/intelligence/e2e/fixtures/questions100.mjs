...
export const QUESTIONS = [
  ...
  { id: 'A01', category: 'A', mode: 'manual', question: 'What is your name?', expected_behavior: 'Candidate first-person name from resume, never "I\'m 秒答".', expectedVoice: 'first_person_candidate', profileShouldBeUsed: true },
  ...
  { id: 'C06', category: 'C', mode: 'what-to-answer', question: 'Can you introduce yourself?', expected_behavior: 'First-person intro from resume (live copilot), never "I\'m 秒答".', expectedVoice: 'first_person_candidate', profileShouldBeUsed: true },
