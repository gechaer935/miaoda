...
process.env.MIAODA_CONVERSATION_MEMORY_V2 = 'true';
process.env.MIAODA_MEETING_MEMORY_V2 = 'true';
process.env.MIAODA_PROFILE_TREE_V2 = 'true';
process.env.MIAODA_GLOBAL_SEARCH_V2 = 'true';
process.env.MIAODA_IN_MEETING_SEARCH_V2 = 'true';
process.env.MIAODA_INTELLIGENCE_ATTRIBUTION = 'true';
...
function score(item, res) {
  ...
  if (e.noAssistantLeak && res.answer) ok('no_assistant_leak', !/I'?m 秒答|I am 秒答|an AI assistant/i.test(res.answer));
