...
const SETS = {
  ...
  H3_sales: { surface: 'manual', qs: ['What is 秒答?', 'What does your product do?', 'Who is this for?', 'What problem do you solve?', 'Give me the elevator pitch.', 'What is 秒答 built with?', 'What platforms does it support?', 'Why should I pay when ChatGPT exists?', 'How is 秒答 different from Cluely?', 'Your product is expensive.'] },
