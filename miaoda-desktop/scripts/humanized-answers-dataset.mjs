...
// coding prompts — NO 秒答-specific facts, no expected fixed answers. Each item only
...
export const QUESTIONS = [
  ...
  // ── identity boundary (5) ──
  { id: 'id-01', mode: 'general', q: 'What is 秒答?', expect: { assistantIdentity: true } },
  ...
  { id: 'id-05', mode: 'general', q: 'How is 秒答 different from Cluely?', expect: {} },
];
