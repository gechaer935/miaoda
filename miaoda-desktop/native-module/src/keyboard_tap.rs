...
//!
//! NSPanel + becomesKeyOnlyIfNeeded already prevents the app from activating
...
//! The app NEVER becomes the key window for keyboard input. The user's Zoom
...
fn tap_callback_inner(
    ...
    // User report: "shortcuts of the macbook aren't working when the app
