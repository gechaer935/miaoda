...
#[path = "stealth_window_win.rs"]
pub mod stealth_window;

#[cfg(target_os = "windows")]
pub mod shortcut_recorder_win;

#[cfg(target_os = "windows")]
pub use shortcut_recorder_win::{get_pressed_shortcut_key, ShortcutKeyInput};
...
///
/// All targets supported by the app (macOS x64/arm64, Windows x64, Linux x64)
